...
#this waiter acts as our arbitrator for the philosophers
...
class Philosopher(threading.Thread):
    ...
    def run(self):
        ...
        """
        Philosophers can only grab forks if they can aquire the lock 
        from the waiter. if one of a philosophers forks is in use
        he waits with the lock until the previous philosipher puts
        down the forks.
        """
        while True:
            with waiter:
